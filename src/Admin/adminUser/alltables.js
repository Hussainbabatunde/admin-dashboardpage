                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.PAYMENTSTATUS ==="ongoing" ? <img src={creative} width="40" height="40" style={{borderRadius:"50%"}}/>:
                      row.PAYMENTSTATUS ==="cancelled" ? <img src={be} width="40" height="40" style={{borderRadius:"50%"}}/>:
                      <img src={facebook} width="40" height="40" style={{borderRadius:"50%"}}/>} {row.PAYMENTSTATUS}</TableCell>
